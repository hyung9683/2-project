			...
			<div class="form-container">
				<div v-for="item in content" :key="item.qna_no" class="post">
					<div class=text>
						...
						<button type="button" class="main_btn" onclick="location.href='/admin/qna?page=1'">목록</button>
						<button type="button" class="btn" @click="moveToWrite(item)">답변</button>
