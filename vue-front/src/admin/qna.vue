        ...
        <h1>고객센터 관리</h1>
         <div class="dropdown" style="margin-left:760px;">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#" @click="sortList(0)">전체</a></li>
                        <li><a class="dropdown-item" href="#" @click="sortList(1)">미답변</a></li>
                    </ul>
                </div>
...
export default {
    ...
    methods: {
        ...
        async getAllList2(sortCase) {
            try {
                const response = await axios.get(`http://localhost:3000/admin/ans/${sortCase}`);
                this.contentlist = response.data;
