    ...
    <div>
      <div class="content" v-for="notice in content" :key="notice.notice_no">
        <div class="notice_content">
          ...
          <div>
          <div class="t2">제목</div>
          <textarea class="text2" :disabled="editable === false" v-model="content[0].notice_tit" style="font-size: 17px;"></textarea>
  
          <div class="t2">내용</div>
          <textarea class="text1" :disabled="editable === false" v-model="content[0].notice_content" style="font-size: 17px;"></textarea>
